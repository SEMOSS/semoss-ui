...
interface FilePptxViewContentProps {
	content: Uint8Array;
	fileName: string;
...
/**
 * Thin wrapper around the pptx engine so the view can lazy-load it; the
 * viewer bundle and its stylesheet stay out of the main client chunk.
 */
const FilePptxViewContent = forwardRef<
	PowerPointViewerHandle,
	FilePptxViewContentProps
...
FilePptxViewContent.displayName = "FilePptxViewContent";

export { FilePptxViewContent };
