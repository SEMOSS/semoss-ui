...
export interface SandpackHtmlPreviewProps {
	html: string;
	className?: string;
	style?: CSSProperties;
...
/** Renders a static HTML document in a sandboxed Sandpack preview iframe. Ported verbatim from playground's response-message-text/sandpack-html-preview.tsx — already self-contained (no room/store dependency). */
export function SandpackHtmlPreview({
	html,
	className,
	style,
	providerClassName,
