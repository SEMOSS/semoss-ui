...
export const ENGINE_IMAGES: Record<string, EngineImageEntry[]> = {
	...
	FUNCTION: [
		...
		{ name: "ZIP", icon: "ZIP.png" },
	],
	GUARDRAIL: [
		{ name: "DETOXIFY", icon: "DETOXIFY.png" },
		{ name: "EMBEDDED_DETOXIFY", icon: "DETOXIFY.png" },
		{ name: "EMBEDDED_GLINER", icon: "GLINER.png" },
	...
	DATABASE: [
		...
		{ name: "ATHENA", icon: "ATHENA.png" },
		{ name: "BIG_QUERY", icon: "BIGQUERY.png" },
		{ name: "CASSANDRA", icon: "CASSANDRA.svg" },
		{ name: "CLICKHOUSE", icon: "CLICKHOUSE.png" },
		...
		{ name: "HIVE", icon: "HIVE.jpg" },
		{ name: "IMPALA", icon: "IMPALA.png" },
		{ name: "JENA", icon: "APACHE_JENA.svg" },
		{ name: "JENA_TDB", icon: "APACHE_JENA.svg" },
		{ name: "MARIA_DB", icon: "MARIA_DB.png" },
