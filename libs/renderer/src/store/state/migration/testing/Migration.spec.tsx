...
for (const testData of testsData) {
    describe("Migration Manager starting from " + testData.name, () => {
        ...
        it("should migrate from 1.0.0-alpha.10 to 1.0.0-alpha.11; aggregateFormatter3 (echart-scatter-plots OR echart-stack-chart)", async ({
            skip,
        }) => {
            const initialState = {
                blocks: {
        ...
        it("should migrate from 1.0.0-alpha.10 to 1.0.0-alpha.11; aggregateFormatter3 (echart-world-map-chart)", async ({
            skip,
        }) => {
            const initialState = {
                blocks: {
                        ...
                        data: {
                            ...
                            option: {
                                _state: {
                                    fields: {
                                        Latitude: "LATITUDE",
                                        LatitudeDataType: "STRING",
                                        Longitude: "LONGITUDE",
                                        LongitudeDataType: "NUMBER",
                                    },
                                },
                            },
                            aggregate: null,
