...
import { TypeLlmComparisonForm } from "../../../../types";
import { ActionMessages, CellState, Variant } from "../../../../store";
...
import { generateVariantName } from "../utility";
...
export const ConfigureSubMenu = observer(() => {
    ...
    const addVariantToAppJson = () => {
        ...
        console.log("Fix types in LLMComparison Context", editorVariantName);
        console.log("Fix types in LLMComparison Context", editorVariant);
