...
import {config as GoogleDocsBlockConfig, GoogleDocsBlockDef } from "./googledocs-block";
...
export const DefaultBlocks: Registry<DefaultBlockDefinitions> = {
    ...
    [GoogleDocsBlockConfig.widget]: GoogleDocsBlockConfig,
