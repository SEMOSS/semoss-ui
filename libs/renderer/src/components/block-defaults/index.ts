...
import {config as GoogleCalendarBlockConfig, GoogleCalendarBlockDef } from "./googlecalendar-block";
...
export const DefaultBlocks: Registry<DefaultBlockDefinitions> = {
    ...
    [GoogleCalendarBlockConfig.widget]: GoogleCalendarBlockConfig,
