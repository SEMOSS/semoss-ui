...
export const VisualMap = observer(
    <D extends BlockDef = BlockDef>({ selectedItem, handleClose }) => {
        ...
        const handleSearch = (e: React.ChangeEvent<HTMLInputElement>) => {
            ...
            const filtered = Object.entries(VisualMapConstant).reduce((acc, [key, value]) => {
                const filteredItems = Array.isArray(value) ? value.filter((item) =>
        ...
        return (
            <StyledMain>
                ...
                <hr style={{ marginTop: "20px", border: "1px solid #E0E0E0" }} />
                <StyledVisualMapSection>
