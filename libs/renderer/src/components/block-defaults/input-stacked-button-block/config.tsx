...
import { InputStackedButtonBlockDef, InputStackedButtonBlock } from "./InputStackedButtonBlock";
...
export const config: BlockConfig<InputStackedButtonBlockDef> = {
    ...
    render: InputStackedButtonBlock,
    icon: FormatShapes,
    contentMenu: [
        {
            name: "General",
