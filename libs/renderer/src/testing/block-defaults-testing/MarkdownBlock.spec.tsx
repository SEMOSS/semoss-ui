...
describe("Markdown Block", () => {
    test("should render correctly with mocked provider", async () => {
    ...
    test("should render content in markdown properly", async () => {
    ...
    test("should render streaming markdown content after animation", async () => {
    ...
    test("should apply styles to the block", async () => {
        const { container } = render(<MarkdownBlock id="markdown" />, {
            blocks: blocks,
        });
