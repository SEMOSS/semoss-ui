import type { WorkbenchPanelParams, WorkbenchPanelType } from "../store";
 ...
 *
 * This is the one place the dock names something host-specific, and it is a
 * data attribute rather than an import -- the package still depends on
 * nothing. Inverting it (a generic opt-in the dock defines) would instead
 * make every host hardcode a workbench attribute, which is a worse trade.
 */
