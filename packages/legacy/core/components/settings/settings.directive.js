...
import './settings-insights/settings-insights.directive';
import './settings-theme/settings-theme.directive';
import './settings-query/settings-query.directive';
import './settings-social/settings-social.directive';
import './settings-permissions/settings-permissions.directive';
import './settings-general/settings-general.directive';
import './settings-admin/settings-admin.directive';
import './settings-table/settings-table.directive';
import './settings-list-item/settings-list-item.directive';
