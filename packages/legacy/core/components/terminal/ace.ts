...
// Custom Mode for Formula
import './mode-formula';
ace.define('ace/snippets/pixel', [], function (e, t, n) {
    'use strict';
    (t.snippetText = undefined), (t.scope = 'pixel');
});
(function () {
    ace.require(['ace/snippets/pixel'], function (m) {
...
ace.define('ace/mode/doc_comment_highlight_rules', [], function (e, t, n) {
    'use strict';
    var r = e('../lib/oop'),
    ...
    ace.define('ace/mode/pixel_highlight_rules', [], function (e, t, n) {
        'use strict';
        function a(e) {
            return [
                {
        ...
        var r = e('../lib/oop'),
            ...
            u = function (e) {
                const t = this.createKeywordMapper({}, 'identifier'),
                    n =
        ...
        r.inherits(u, s), (t.PixelHighlightRules = u);
    }),
    ace.define('ace/mode/matching_brace_outdent', [], function (e, t, n) {
        'use strict';
    ...
    ace.define('ace/mode/folding/cstyle', [], function (e, t, n) {
        'use strict';
        const r = e('../../lib/oop'),
            i = e('../../range').Range,
    ...
    ace.define('ace/mode/pixel', [], function (e, t, n) {
        'use strict';
        const r = e('../lib/oop'),
            i = e('./text').Mode,
            s = e('./pixel_highlight_rules').PixelHighlightRules,
        ...
        r.inherits(l, i),
            function () {
                (this.lineCommentStart = '//'),
                    ...
                    (this.$id = 'ace/mode/pixel');
            }.call(l.prototype),
            (t.Mode = l);
    });
(function () {
    ace.require(['ace/mode/pixel'], function (m) {
        if (typeof module == 'object' && typeof exports == 'object' && module) {
            module.exports = m;
        }
    });
