...
import L from '@/widget-resources/js/leaflet/leaflet';
import '@/widget-resources/js/leaflet/L.Popup.Angular';
import '@/widget-resources/js/leaflet/Leaflet.VectorGrid.bundled';
