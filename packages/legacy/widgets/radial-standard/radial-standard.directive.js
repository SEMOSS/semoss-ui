...
export default angular
    .module('app.radial-standard.directive', [])
    .directive('radialStandard', radialStandard);

radialStandard.$inject = ['$timeout', 'semossCoreService'];

function radialStandard($timeout, semossCoreService) {
    radialStandardLink.$inject = ['scope', 'ele', 'attrs', 'ctrl'];

    return {
        restrict: 'E',
        require: ['^widget', '^visualization'],
        link: radialStandardLink,
    };

    function radialStandardLink(scope, ele, attrs, ctrl) {
