...
import { PREVIEW_LIMIT } from '../../core/constants';
import Resizable from '../../core/utility/resizable-old';

import './pipeline-app.scss';

import './pipeline-app-filter/pipeline-app-filter.directive';
import './pipeline-app-calculation/pipeline-app-calculation.directive';
