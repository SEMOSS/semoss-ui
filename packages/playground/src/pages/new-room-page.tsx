...
export const NewRoomPage = observer(() => {
  ...
  const [options, setOptions] = useState<RoomStore["options"]>({
    ...
    tokenLength: root.theme.defaultRoomSettings?.tokenLength || TOKEN_LENGTH,
    temperature: root.theme?.defaultRoomSettings?.temperature || TEMPERATURE,
    workspace: null,
  });
  ...
  useEffect(() => {
    ...
    setOptions((prev) => {
      ...
      return {
        ...prev,
        instructions: getWorkspace.data?.system_prompt || prev.instructions,
        mcp: workspaceMCPs,
      };
    });
        ...
        <ResizablePanel className="relative flex flex-col items-center justify-center overflow-auto p-2">
          ...
          <div className="z-10 mx-auto flex w-full max-w-2xl flex-col gap-6">
            ...
            <RoomInput
              ...
              MenuComponent={observer(({ addToken, onOpenChange, fileRef }) => (
                <>
                  <DropdownMenuItem
                    onSelect={() => {
                      setMode({
                  ...
                  <RoomInputMenuWorkspace
                    workspace={
                      mode.type === "workspace" ? mode.workspace : null
                    }
                  ...
                  >
                    ...
                    <span className="flex-1">
                      {isConfigurationOpen ? "Close" : "Open"} Settings
                    </span>
                  </DropdownMenuItem>
                </>
              ))}
