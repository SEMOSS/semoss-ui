...
export const KnowledgeOverlayComponent: React.FC<KnowledgeOverlayComponentProps> =
    (props) => {
        ...
        const [newEngineData, setNewEngineData] =
            useState<NewKnowledgeData | null>(null);
        ...
        const onSave = async () => {
            ...
            try {
                ...
                if (newEngineData) {
                    ...
                    // store the id
                    newEngineId =
                        createEngine.pixelReturn[0].output.database_id;
                    const newEngineName =
