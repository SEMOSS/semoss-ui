...
const StyledIconButton = styled(IconButton)(({ theme }) => ({
    backgroundColor: theme.palette.primaryContrast['700'] + '1D',
    color: theme.palette.primaryContrast['700'],
}));
...
interface MultipleFileDropzoneProps
    extends BaseFileDropzoneProps<File[] | FileObj[] | null> {
    multiple: true;
}
...
const _FileDropzone = <Multiple extends boolean>(
    ...
    function updateFiles(files: File[]) {
        ...
        for (
            ...
            if (Object.prototype.hasOwnProperty.call(names, file.name)) {
        ...
        <StyledContainer ref={ref} {...otherProps}>
            ...
            >
                <StyledContentContainer>
                    <StyledIconButton
                        aria-label={
                            ariaLabel ? ariaLabel : 'Browse files to upload'
                        }
                        size="small"
                        onClick={(e) => {
                            e.stopPropagation();
