...
export default function App() {
	...
	const isRoomRecordingSource =
		toolContext?.engineType?.toUpperCase() === "ROOM" ||
		toolContext?.engineId === "__room__";
	...
	useEffect(() => {
		...
		(async () => {
			...
			// A same-named room recording wins over an app recording. Room MCP
			// files live directly under /playwright in the new generic room model.
			if (exactFileName) {
