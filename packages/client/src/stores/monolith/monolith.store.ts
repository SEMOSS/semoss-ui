...
export class MonolithStore {
   ...
   * @returns
   */
  async addEngineUserPermissions(admin: boolean, appId: string, users: any[]) {
    let url = `${Env.MODULE}/api/auth/`,
      postData = "";
    ...
    postData += "&userpermissions=" + encodeURIComponent(JSON.stringify(users));
   ...
   * @returns
   */
  async editEngineUserPermissions(admin: boolean, appId: string, users: any[]) {
    let url = `${Env.MODULE}/api/auth/`,
      postData = "";
   ...
   * @param visible
   */
  async setEngineVisiblity(admin: boolean, engineId: string, visible: boolean) {
    let url = `${Env.MODULE}/api/auth/`,
      postData = "";
  ...
  async denyEngineUserAccessRequest(
    ...
    postData += "engineId=" + encodeURIComponent(engineId);
    postData += "&requestIds=" + encodeURIComponent(JSON.stringify(userIds));
   ...
   * @returns
   */
  async addProjectUserPermissions(admin: boolean, appId: string, users: any[]) {
    let url = `${Env.MODULE}/api/auth/`,
      postData = "";
