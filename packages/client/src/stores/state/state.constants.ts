...
export const DEFAULT_TEMPLATE: Template[] = [
    ...
    {
        name: 'Blocks Guide',
        description: 'Introduction to using blocks.',
        image: QUERY,
        author: 'SYSTEM',
        lastUpdatedDate: new Date().toISOString(),
        // tags: ['NLP', 'SQL', 'LLM'],
                    ...
                    cells: [
                        {
                            ...
                            widget: 'code',
                            parameters: {
                                code: 'x = "This is sample query output text"\r\n\r\nx',
                                type: 'py',
                            },
                        },
                    ],
                    ...
                    cells: [
                        {
                            ...
                            widget: 'code',
                            parameters: {
                                code: "x = 'The box is checked' if ('{{block.checkbox--5820.value}}' == 'true') else 'The box is unchecked'\r\n\r\nx",
                                type: 'py',
                            },
                        },
                    ],
                    ...
                    cells: [
                        {
                            ...
                            widget: 'code',
                            parameters: {
                                code: "x = 'My lucky number is: ' + '{{block.input--6319.value}}'\r\n\r\nx",
                                type: 'py',
                            },
                        },
                    ],
                    ...
                    cells: [
                        {
                            ...
                            widget: 'code',
                            parameters: {
                                code: "x = 'My birthday is: ' + '{{block.input--2303.value}}'\r\n\r\nx",
                                type: 'py',
                            },
                        },
                    ],
                    ...
                    cells: [
                        {
                            ...
                            widget: 'code',
                            parameters: {
                                code: "x = ['Bird of Paradise', 'Monstera', 'Palm', 'Pothos', 'Snake Plant', 'Spider Plant']\r\n\r\nx",
                                type: 'py',
                            },
                        },
                    ],
                    ...
                    cells: [
                        {
                            ...
                            widget: 'code',
                            parameters: {
                                code: "x =  'Uploaded file: ' + '{{block.upload--6197.value}}'\r\n\r\nx",
                                type: 'py',
                            },
                        },
                    ],
                    ...
                    cells: [
                        {
                            ...
                            widget: 'code',
                            parameters: {
                                code: "x = 'The toggle value is: ' + '{{block.toggle-button--5325.value}}'\r\n\r\nx",
                                type: 'py',
                            },
                        },
                    ],
            ...
            blocks: {
                ...
                'text--961': {
                    ...
                    data: {
                        ...
                        text: 'Below is a radial plot with predefined values that you can adjust on your own.',
                        variant: 'p',
                    },
                    listeners: {},
                    slots: {},
