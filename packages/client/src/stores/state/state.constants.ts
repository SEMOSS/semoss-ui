                    ...
                    cells: [
                        {
                            ...
                            parameters: {
                                code: [
                                    ...
                                    "print('Queries')",
                                    'print("--------------------------")',
                                    'print("New way to reference query value: " + "{{query}}")',
                                    'print("New way to reference query value: " + "{{py_code}}")',
                                    'print("New way to reference query executed: " + "{{py_code.isExecuted}}")',
                                    "print('--')",
                                    'print("Old way to reference query value: " +  "{{query.python_code.output}}")',
                                    'print("Old way to reference query loading: " +  "{{query.python_code.isLoading}}")',
                                    'print("This should breaks: {{query.test.isLoading}}")',
                                    'print("--------------------------")',
                                    "print('Cells')",
                                    'print("--------------------------")',
                                    'print("New way to reference cell value: " + "{{cell}}")',
                                    'print("New way to reference cell loading: " + "{{cell.isLoading}}" )',
                                    "print('--')",
                                    'print("Old way to reference cell value: " +  "{{query.python_code.cell.21756.output}}")',
                                    'print("Old way to reference cell loading: " +  "{{query.python_code.cell.21756.isLoading}}")',
                                    'print("--------------------------")',
                                    "print('Blocks')",
                                    'print("--------------------------")',
                                    'print("New way to reference block value: " + "{{block}}") # Variable named block to not collide with old stuff and old syntax',
                                    'print("Old way to reference block value: " +"{{block.input--7673.value}}")',
                                    'print("New way to reference properties of block: " + "{{block.label}}")',
                                    'print("Old way to reference properties of block: " +"{{block.input--7673.label}}")',
                                ],
                                type: 'py',
                            },
                        },
            ...
            blocks: {
                ...
                'input--7673': {
                    ...
                    data: {
                        ...
                        value: 'this is the old way to reference',
                        label: 'Example Input',
                        hint: '',
                        type: 'text',
                        rows: 1,
