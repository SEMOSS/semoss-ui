...
const StyledCard = styled(Card)<{ isExpanded: boolean }>(
	({ theme, isExpanded }) => ({
		borderRadius: "16px",
...
const StyledResultsContent = styled("div")<{ isExpanded: boolean }>(
	({ isExpanded }) => ({
		flex: 1,
		overflow: "auto",
		minHeight: 0,
...
// Footer section
const StyledFooter = styled("div")<{ isExpanded: boolean }>(
	({ theme, isExpanded }) => ({
