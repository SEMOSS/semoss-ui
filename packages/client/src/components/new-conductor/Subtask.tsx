    ...
    ({
        ...
        const playClickHandler = async (subTaskIdx: number) => {
            ...
            if (conductor.subTasks[subTaskIdx]?.isSetupComplete == false) {
                ...
                const selectedAppId =
                    conductor.subTasks[subTaskIdx]?.selectedAppId;
                alert(
        ...
        return (
            <>
                                        ...
                                        <div>
                                            {(activeStep == 0 ||
                                                ...
                                                <Box>
                                                    <Typography
                                                        ...
                                                        sx={{ mt: 2, mb: 1 }}
                                                    >
                                                        These apps might be a
                                                        good fit for this
                                                        subtask. Select one to
                                            ...
                                            {activeStep == 2 && (
                                                ...
                                                >
                                                    ...
                                                    >
                                                        Map the inputs and
                                                        outputs from the app to
                                                        the subtask inputs and
                                                        outputs.
                                                    </Typography>
                                                    <Typography
                                                        variant="body2"
                ...
                <SubTaskPlayButton>
                    ...
                    >
                        <IconButton onClick={() => playClickHandler(taskIndex)}>
                            <PlayArrow />
                        </IconButton>
                    </div>
                </SubTaskPlayButton>
