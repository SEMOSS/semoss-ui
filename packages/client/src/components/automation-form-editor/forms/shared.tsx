...
import { TRANSFORM_MODES } from "../../automation-workspace/automation-utils";
...
export function outputVarHint(_type: string): string {
	return "";
}
...
export function OutputTransformSection({
	...
	node: AutomationNode;
	onUpdate: (n: AutomationNode) => void;
}) {
		...
		<details className="group rounded-md border border-border">
			...
			<div className="flex flex-col gap-3 border-border border-t p-3">
				<p className="text-[10px] text-muted-foreground">
					...
					Applied in both test runs and full automation runs.
				</p>
				<Field>
