...
export const DEFAULT_MENU: DesignerMenuItem[] = [
    ...
    },
    {
        section: SECTION_INPUT,
        name: 'Input Stacked',
        helperText: 'Add an input stacked box for typing text',
        activeImage: BLOCK_IMAGES['INPUT_ACTIVE'],
        hoverImage: BLOCK_IMAGES['INPUT_HOVER'],
        json: {
    ...
    {
        section: SECTION_INPUT,
        name: 'Input Stacked Button',
        helperText: 'Add an input stacked button box for typing text',
        activeImage: BLOCK_IMAGES['INPUT_ACTIVE'],
        hoverImage: BLOCK_IMAGES['INPUT_HOVER'],
        json: {
            ...
            data: {
                ...
                value: '',
                label: 'Example Input Stacked Button',
                hint: '',
                type: 'text',
                rows: 1,
                multiline: false,
