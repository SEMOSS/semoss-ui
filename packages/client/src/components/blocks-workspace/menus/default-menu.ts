...
//     section: SECTION_INPUT,
//     name: "Date Picker",
//     helperText: "Select a date from the calendar interface",
//     activeImage: BLOCK_IMAGES["DATE_PICKER_ACTIVE"],
//     hoverImage: BLOCK_IMAGES["DATE_PICKER_HOVER"],
//     json: {},
//   },
  {
    section: SECTION_INPUT,
              ...
              data: [
                {
                  ...
                  children: [
                    ...
                    {
                      name: "Child B",
                      children: [{ name: "Leaf B1" }, { name: "Leaf B2" }],
                    },
                  ],
                },
              ],
  ...
  },
  {
    ...
    helperText: "Use the sidebar to navigate between the tools and components",
    json: {
      widget: "sidebar",
      data: {
        style: {
