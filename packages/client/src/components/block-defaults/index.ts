...
import {
    config as SelectEngineBlockConfig,
    SelectEngineBlockDef,
} from './select-engine-block';
...
export const DefaultBlocks: Registry<DefaultBlockDefinitions> = {
    ...
    [SelectEngineBlockConfig.widget]: SelectEngineBlockConfig,
};
