...
export interface VisualizationToolDef {
    showTool: boolean;
    id: any;
}

export interface VisualizationTools {
...
export interface DisabledVisualizationTools {
...
const VisualizationTool = observer<VisualizationToolDef>(({ showTool, id }) => {
    ...
    const [featureDisabled, setFeatureDisabled] =
        useState<DisabledVisualizationTools>({
    ...
    function zoomChartButton(event, optionSrc) {
        ...
        if (option['dataZoom']) {
            ...
            if (xAxisPosition > -1) {
                option['dataZoom'][xAxisPosition].show = event.xAxisZoomShow;
            } else {
        ...
        setShowFeatureSection((prevshowFeatureSection) => {
            return {
                ...
                xAxisDataZoomShow: !prevshowFeatureSection.xAxisDataZoomShow,
            };
        });
    ...
    function yAxisZoomChartButton(event, optionSrc) {
        ...
        if (option['dataZoom']) {
            ...
            if (yAxisPosition > -1) {
                option['dataZoom'][yAxisPosition].show = event.yAxisZoomShow;
            } else {
                option['dataZoom'].push({
        ...
        setShowFeatureSection((prevshowFeatureSection) => {
            return {
                ...
                yAxisDataZoomShow: !prevshowFeatureSection.yAxisDataZoomShow,
            };
        });
        // runStateUpdate(option);
        return option;
