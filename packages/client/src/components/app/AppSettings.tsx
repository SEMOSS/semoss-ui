...
export const AppSettings = (props: AppSettingsProps) => {
  ...
  /** LOADING */
  if (getPortalDetails.status !== "SUCCESS") {
    return <LoadingScreen.Trigger description="Getting app portal details" />;
  }
          ...
          <StyledCardDiv>
            <StyledCardLeft>
              ...
              <StyledLeftActionContainer>
                {portalDetails.lastCompiled && (
                  <StyledLeftActionDiv>
                    <StyledActionDivLeft>
                      <Typography variant="body2">Last compiled by:</Typography>
                    </StyledActionDivLeft>
                    <Avatar>
                      <StyledPersonIcon />
                    </Avatar>
            ...
            <StyledCardRight>
              <StyledSubColumn>
                <StyledSubRow>
                  <StyledSwitchIcon />
                  <Typography variant="subtitle1">Enable Publishing</Typography>
                </StyledSubRow>
              ...
              <>
                ...
                <StyledSubColumn>
                  <StyledSubRow>
                    <StyledRefreshIcon />
                    <Typography variant="subtitle1">Publish Portal</Typography>
                  </StyledSubRow>
