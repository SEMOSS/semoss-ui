...
export const CustomFrameToVisualizationTemplate: Template = {
  ...
  description: "This is simply a guide to show you how to create a pandas data frame and use that frame to show a visualization.  Use imagination to build more useful app use cases.",
  image: CHATAI,
  author: "SYSTEM",
