      ...
      <StyledDiv>
        <Stack>
          ...
          <Typography variant="body1" color={"secondary"}>
            Please provide the name, type, and model to uniquely identify,
            categorize, and configure your setup for optimal performance.
          </Typography>
        </Stack>
        <StyledDiv>
          <StyledFormContainer>
            <StyledFormDiv>
              <TextField
                ...
                disabled={true}
                onChange={(e) => handleChange("FUNCTION_TYPE", e.target.value)}
              />
            </StyledFormDiv>
            <StyledFormDiv>
              <TextField
            ...
            <StyledFormDiv>
              <TextField
                ...
                onChange={(e) =>
                  handleChange("FUNCTION_PARAMETERS", e.target.value)
                }
              />
            </StyledFormDiv>
            <StyledFormDiv>
              <TextField
                ...
                onChange={(e) =>
                  handleChange("FUNCTION_REQUIRED_PARAMETERS", e.target.value)
                }
              />
            </StyledFormDiv>
            <StyledFormDiv>
              <StyledTextArea
                ...
                onChange={(e) =>
                  handleChange("FUNCTION_DESCRIPTION", e.target.value)
                }
              />
            </StyledFormDiv>
            <StyledFormDiv>
              <TextField
                ...
                onChange={(e) =>
                  handleChange("PYTHON_FILE_NAME", e.target.value)
                }
              />
            </StyledFormDiv>
