              ...
              <StyledKeyValue key={i}>
                <Controller
                  ...
                  render={({
                    ...
                    if (val.options.component === "text-field") {
                      return (
                        <TextField
                          id={`${val.fieldName}`}
                          inputRef={ref}
                          ...
                          error={invalid}
                          inputProps={{
                            "data-testId": formatToDataTestId(`importForm-${val.fieldName}-textField`),
                          }}
                          {...field}
                        ></TextField>
                      );
                    } else if (val.options.component === "password") {
                      return (
                        <TextField
                          id={`${val.fieldName}`}
                          type="password"
                    ...
                    } else if (val.options.component === "select") {
                      return (
                        <Select
                          fullWidth
                          required={val.rules.required}
                          ...
                          onChange={(value) => {
                            field.onChange(value);
                            checkForDisplayRulesSet(field, value.target.value);
                          }}
                          InputProps={{
                            "data-testId": formatToDataTestId(`importForm-${val.fieldName}-select`),
                          }}
                          helperText={val.helperText}
                        >
                          {val.options.options.map((opt, i) => {
                            return (
                              <Menu.Item
                                key={i}
                                value={opt.value}
                                data-testId={formatToDataTestId(`importForm-${opt.display}-item`)}
                              >
                                {opt.display}
                              </Menu.Item>
                            );
                    ...
                    } else if (val.options.component === "number") {
                      return (
                        <TextField
                          id={`${val.fieldName}`}
                          type="number"
                    ...
                    } else if (val.options.component === "file-upload") {
                      return (
                        <StyledDropzoneField>
                          ...
                          <FileDropzone
                            ...
                            value={field.value}
                            disabled={false}
                            data-testid={formatToDataTestId(`importForm-${val.fieldName}-fileDropZone`)}
                            onChange={(newValues) => {
                    ...
                    <StyledKeyValue key={i}>
                      <Controller
                        ...
                        render={({ field, fieldState }) => {
                          ...
                          if (val.options.component === "text-field") {
                          ...
                          } else if (val.options.component === "checkbox") {
                            return (
                              <Checkbox
                                required={val.rules.required}
                                label={val.label}
                            ...
                            return (
                              ...
                              >
                                {val.options.options.map((opt, i) => {
                                  return (
                                    <Menu.Item key={i} value={opt.value}  data-testId={formatToDataTestId(`importForm-${opt.display}-item`)}>
                                      {opt.display}
                                    </Menu.Item>
                                  );
                                })}
                          ...
                          } else if (val.options.component === "zip-upload") {
                            return (
                              <FileDropzone
                                multiple={false}
                                value={field.value}
                                ...
                                onChange={(newValues) => {
                                  field.onChange(newValues);
								                ...
								                data-testId={formatToDataTestId(`importForm-${val.fieldName}-zipUpload`)}
                              />
                            );
                          }
                        }}
