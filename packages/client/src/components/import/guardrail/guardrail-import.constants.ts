    ...
    fields: [
        {
            ...
            rules: {
                pattern: {
                    value: /^[\w\-\s]+$/,
                    message: "Catalog names can only contain alphanumeric characters and dashes.",
                },
                custom_rules: {
                    value: 'CheckEngineName ( "[VALUE]") ;',
        ...
        },
        {
            ...
            required: false,
            category: "Settings",
            helperText: "Minimum similarity score (0-1) for a prompt to be considered on-topic. Defaults to 0.5.",
        },
        {
            key: "LIMIT",
            ...
            required: false,
            category: "Settings",
            helperText: "Number of nearest neighbours retrieved from the vector database per query. Defaults to 5.",
        },
        {
            key: "GUARDRAIL_TYPE",
            label: "Guardrail Type",
...
},
{
    ...
    notice:
        "After creating this guardrail engine, upload your Python file and any supporting files from the guardrail Edit page. The function named in 'Guardrail Function Name' must return a dict with 'pass' (boolean), plus optional 'returnPrompt' (string) if masking is supported and optional 'fullDetails' (object).",
    fields: [
        {
            key: "MODEL_NAME",
            label: "Catalog Name",
        ...
        },
        {
            ...
            disabled: false,
            required: false,
            helperText: "List the parameter names above that must be supplied when the guardrail is executed.",
            category: "Settings",
        },
    ],
},
