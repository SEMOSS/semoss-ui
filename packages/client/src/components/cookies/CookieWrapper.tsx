...
"helpBannerOrder": ["documentation", "tutorials", "privacy-notice", "platform-tour", "github", "feedback"],
"helpBannerValues": {"documentation": {"label": "Documentation", "src": "https://workshop.cfg.deloitte.com/docs/"}, "tutorials": {"label": "Tutorials", "src": "https://workshop.cfg.deloitte.com/docs/category/app-creation-guides"}, "privacy-notice": {"label": "Privacy Notice", "src": "", "disabled": true}, "platform-tour": {"label": "Platform Tour", "src": "", "disabled": true}, "github": {"label": "Github", "src": "", "disabled": true}, "feedback": {"label": "Feedback", "src": "", "disabled": true}},
"termsHeaderReact": "Attention",
"termsReact": "<p>Please be advised that the use of Large Language Models (LLMs) in this application may be subject to specific guidelines or restrictions based on your organization’s policies. Before proceeding, we recommend consulting with your member firm for guidance on the appropriate use of LLMs to ensure compliance with relevant regulations and best practices.</p>", 
"cookiePolicyModalBodyReact": "<div><p><b>Your Privacy</b></p><p>When you visit any website, it may store or retrieve information on your browser, mostly in the form of cookies. This information might be about you, your preferences or your device and is mostly used to make the site work as you expect it to. The information does not usually directly identify you, but it can give you a more personalized web experience.</p><p>Because we respect your right to privacy, you can choose not to allow some types of cookies. Click on the different category headings to find out more and change our default settings. However, blocking some types of cookies may impact your experience of the site and the services we are able to offer.</p><p><a href=\"https://cookienotice.deloitte.com/\" target=\"_blank\">Cookie policy</a></p></div>",
"cookiePolicyBannerReact": "<div><p><b>This site uses strictly necessary cookies and similar technologies to operate this website and to provide you with a more personalized user experience.</p><p>For more information, please review the <a href=\"https://cookienotice.deloitte.com/\" target=\"_blank\">Cookie policy</a>.</p></div>",
