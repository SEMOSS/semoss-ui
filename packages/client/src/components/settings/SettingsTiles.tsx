  ...
  const changeDiscoverable = async () => {
    try {
      ...
      if (
        ...
        response = await setEngineVisiblity(adminMode, id, !discoverable);
      } else if (type === "APP") {
        response = await setProjectVisiblity(adminMode, id, !discoverable);
      }
        ...
        <Stack direction={direction}>
          ...
          {global ? (
            ...
            >
              ...
              >
                <Alert.Title>
                  <StyledTypography variant="body1" isDisabled={true}>
                    Make Discoverable
                  </StyledTypography>
                </Alert.Title>
            ...
            >
              <Alert.Title>
                <StyledTypography variant="body1" isDisabled={false}>
                  Make Discoverable
                </StyledTypography>
              </Alert.Title>
