    ...
    return (
        <StyledSidebar variant="outlined">
            ...
            <StyledParameterSection>
                ...
                <StyledParameterItem>
                    <StyledParameterHeader>
                        <Typography variant="body1">Max Tokens (Output)</Typography>
            ...
            <Stack spacing={1}>
                ...
                <Typography variant="body2" color="secondary">
                    • Responses may be truncated if they exceed token limits
                </Typography>
                <Typography variant="body2" color="secondary">
                    • Use the "Continue" button if response is incomplete
                </Typography>
                <Typography variant="body2" color="secondary">
