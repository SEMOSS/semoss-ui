...
interface SelectEngineOptionsSettings<D extends BlockDef = BlockDef> {
    /**
...
export const SelectEngineOptionsSettings = observer(
    <D extends BlockDef = BlockDef>({
        id,
        path,
        optionData,
    }: SelectEngineOptionsSettings<D>) => {
        ...
        const handleEngineTypeChange = (newType: string) => {
            ...
            timeoutRef.current = setTimeout(() => {
                try {
                    ...
                    // Reset label and sublabel fields
