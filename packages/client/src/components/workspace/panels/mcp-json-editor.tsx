...
// Custom hook for debouncing (moved from hooks.ts)
...
// Custom hook for JSON validation (moved from hooks.ts)
...
// Custom hook for keyboard shortcuts (moved from hooks.ts)
