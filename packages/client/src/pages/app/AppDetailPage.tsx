...
export const AppDetailPage = () => {
  ...
  async function getPermission() {
    const { permission: role } = await monolithStore.getUserProjectPermission(
      appId
    );
            ...
            <PageBody>
              <TitleSection>
                <Box>
                  ...
                  <TitleSectionBodyWrapper>
                    <Title variant="h6">{appInfo?.project_name}</Title>
                  </TitleSectionBodyWrapper>
                </Box>
              ...
              <ContainerGrid container spacing={2}>
                ...
                <RightColumn item xs={12} md={4}>
                  <PublisherInfo variant="body1">
                    <span>
                      Published by: {appInfo?.project_created_by || "Unknown"}
                    </span>
                    Updated{" "}
                    {appInfo?.project_date_created
                      ? new Date(appInfo?.project_date_created).toLocaleString(
                          "en-US",
                          {
                            month: "long",
                            day: "2-digit",
              ...
              <StyledContentContainer>
                <StyledToggleTabsGroup
                  value={selectedTab}
                  boxSx={StyledTabs}
                  onChange={(_e, val) => setSelectedTab(String(val))}
                >
              ...
              <StyledTabsSection>
                {selectedTab === "Overview" && <Overview appInfo={appInfo} />}
