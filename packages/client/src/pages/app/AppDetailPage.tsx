          ...
          <div>
            ...
            <PageBody>
              <ActionBar>
                ...
                <IconButton
                  onClick={(event) => setMoreVertAnchorEl(event.currentTarget)}
              ...
              <TitleSection>
                ...
                <TitleSectionBodyWrapper>
                  <Typography variant="h6">{appInfo?.project_name}</Typography>
              ...
              <StyledSection ref={markdownRef}>
                <SectionHeading variant="h2">Main uses</SectionHeading>
              ...
              <StyledSection ref={tagsRef}>
                ...
                {tags ? (
                  <TagsBodyWrapper>
                    {tags.map((tag, idx) => (
                      <Chip key={`tag-${tag}-${idx}`} label={tag} />
                    ))}
                  </TagsBodyWrapper>
                ) : (
                ...
                {createRefs.map((k) => {
                  ...
                  return (
                    <StyledSection key={k.metakey} ref={k.ref}>
                      <SectionHeading variant="h2">{k.display}</SectionHeading>
                      <TagsBodyWrapper>
                        ...
                        k.display_options === "select-box" ? (
                          <Stack
                            ...
                            flexWrap={"wrap"}
                          >
                            {(detailsForm[k.metakey] as string[]).map((tag) => {
                              return <Chip key={tag} label={tag}></Chip>;
                            })}
                          </Stack>
                        ) : (
                          (detailsForm[k.metakey] as string)
                        )}
                      </TagsBodyWrapper>
                    </StyledSection>
                  );
              ...
              {permission && permission !== "discoverable" && (
                <StyledSection ref={dependenciesRef}>
                  <DependenciesHeadingWrapper>
                    <SectionHeading variant="h2">Dependencies</SectionHeading>
                    {permission === "author" && (
                      <IconButton
                  ...
                  {dependencies.length > 0 ? (
                    ...
                    <Typography variant="body1">No dependencies</Typography>
                  )}
                </StyledSection>
              )}
              ...
              {permission === "author" && (
                <StyledSection ref={appAccessRef}>
                  <SectionHeading variant="h2">App Access</SectionHeading>
              ...
              {permission &&
                ...
                permission !== "readOnly" && (
                  <StyledSection ref={memberAccessRef}>
                    <SectionHeading variant="h2">Member Access</SectionHeading>
                    <SettingsContext.Provider
                      value={{
                        adminMode: false,
                      }}
              ...
              {(permission === "discoverable" || permission === "readOnly") && (
                <StyledSection ref={similarAppsRef}>
                  <SectionHeading variant="h2">Similar Apps</SectionHeading>
                </StyledSection>
              )}
            </PageBody>
          </div>
...
const Sidebar = ({ permission, refs }: SidebarProps) => {
  ...
  const canEdit =
    permission && permission !== "discoverable" && permission !== "readOnly";
