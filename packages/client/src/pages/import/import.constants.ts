      ...
      OpenAI: [
        {
          ...
          fields: [
            ...
            },
            {
              ...
              defaultValue: "c73f5e23-9876-487e-9cca-94d3503ff36a",
              options: {
                component: "text-field",
              },
              disabled: false,
      ...
      "NVIDIA NIM Models": [
        {
          ...
          fields: [
            ...
            },
            {
              fieldName: "MODEL",
              label: "Model",
              defaultValue: "mistralai/mixtral-8x7b-instruct-v0.1",
              options: {
                component: "select",
                options: [
                  {
                    display: "mistralai/mixtral-8x7b-instruct-v0.1",
        ...
        fields: [
          {
            fieldName: "FUNCTION_TYPE",
            label: "Function Type",
            defaultValue: "AZURE_DOCUMENT_INTELLIGENCE_CUSTOM_EMBEDDINGS",
            options: {
              component: "text-field",
            },
            disabled: true,
