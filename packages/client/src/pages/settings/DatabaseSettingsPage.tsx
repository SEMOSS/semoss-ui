...
import { useAPI, useInfiniteScroll, usePixel, useRootStore } from "@/hooks";
import { useSettings } from "@/hooks/useSettings";
import { getPageSizeBasedOnScreen, removeUnderscores } from "@/utility";
...
export const DatabaseSettingsPage = () => {
  ...
  useEffect(() => {
    ...
    if (getEngines.status === "SUCCESS" && Array.isArray(getEngines.data)) {
      ...
      <StyledContainer>
        <StyledSearchbarContainer>
          ...
          <ToggleButtonGroup size={"small"} value={view}>
            <ToggleButton onClick={(_e, v) => setView(v)} value={"tile"}>
              <SpaceDashboardOutlined />
            </ToggleButton>
            <ToggleButton onClick={(_e, v) => setView(v)} value={"list"}>
              <FormatListBulletedOutlined />
            </ToggleButton>
          </ToggleButtonGroup>
        </StyledSearchbarContainer>
