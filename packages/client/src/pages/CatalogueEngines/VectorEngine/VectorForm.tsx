...
export const VectorForm = ({ id, title, description, fields }) => {
  ...
  const onFormSubmit = async (formData) => {
    ...
    try {
      ...
      const createVectorResponse = await monolithStore.runQuery(
        createVectorPixel
      );
      const createVectorOutput = createVectorResponse.pixelReturn[0].output;
