...
import { Alert, AlertDescription, AlertTitle } from "@semoss/ui/next";
                ...
                return (
                  <TableRow key={job.id}>
                    <TableCell>
                      <input
                        type="checkbox"
                        checked={rowSelectionModel.includes(job.id)}
                    ...
                    <TableCell>
                      ...
                      job.lastRun !== "N/A"
                        ? dayjs(job.lastRun).format("MM/DD/YYYY h:mm A")
                        : ""}
                    </TableCell>
                    ...
                    <TableCell>
						<span
							...
							job.isActive ? "bg-green-600" : "bg-red-600"
							}`}
						>
                    ...
                    <TableCell>
                      <div className="flex gap-2">
                        ...
                        <Button
                          ...
                          disabled={isRunning}
                          onClick={() => showDeleteJobModal(job)}
                        >
