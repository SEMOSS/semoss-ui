...
export default angular
    .module('app.pack-standard.directive', [])
    .directive('packStandard', packStandard);

packStandard.$inject = ['semossCoreService'];

function packStandard(semossCoreService) {
    packStandard.$inject = ['scope', 'ele', 'atts', 'ctrl'];
    ...
    function packStandardLink(scope, ele, attrs, ctrl) {
