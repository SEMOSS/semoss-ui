...
function config(
    ...
    $stateProvider
        ...
        .state('home.catalog2', {
            url: '/catalog2',
            template: '<rewrite src="./client/dist/#/catalog"></rewrite>',
        })
        .state('home.catalog', {
            url: '/catalog',
        ...
        .state('home.catalog.database', {
            ...
            lazyLoad: ($transition$) => {
                ...
                return import(
                    /* webpackChunkName: "components/database" */ './components/database/database.directive.ts'
                )
                    .then((module) => {
                        $ocLazyLoad.load(module.default);
                    })
        ...
        .state('out-of-memory', {
            ...
            lazyLoad: ($transition$) => {
                ...
                return import(
                    /* webpackChunkName: "components/out-of-memory" */ './components/out-of-memory/out-of-memory.directive.ts'
                )
                    .then((module) => {
                        $ocLazyLoad.load(module.default);
                    })
