...
import './workspace-filter/workspace-filter.directive.ts';
import './workspace-panel-filter/workspace-panel-filter.directive.ts';

import '../../../widgets/embed-link/embed-link.directive.ts';
